...
const FooterContent = () => {
  ...
  return (
    ...
    >
      <p>
        <span className='text-textSecondary'>{`© ${new Date().getFullYear()}, Asvoria Launchpad `}</span>
        {/* <span className='text-textSecondary'>{` by `}</span>
        <Link href='https://brdigitech.com' target='_blank' className='text-primary uppercase'>
          Brdigitech
        </Link> */}
      </p>
    </div>
